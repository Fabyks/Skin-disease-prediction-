...
def skin_disease_prediction(request):
    return render(request,'skin_disease_prediction.html')

@login_required(login_url='login')
def get_skin_disease_prediction(request):
    ...
    if request.method  == 'POST':
        ...
        prediction = predict_skin_disease(tmp_file)
        os.remove(tmp_file)
        print(prediction)
        context={
        ...
        return render(request,'skin_disease_prediction.html',context)
    return render(request,'skin_disease_prediction.html')
